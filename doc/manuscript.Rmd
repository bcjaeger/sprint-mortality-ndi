...
tbl_object <- add_footer_lines(tbl_object, values="Abbreviations: CI, confidence interval; FI, frailty index. aChronic Kidney Disease defined as an estimated glomerular filtration rate <60 ml/min/1.73 m2 based on the 2021 CKD-EPI creatinine equation.")
...
knitr::include_graphics(
  path = 'O:/sprint/npajewski/sprint-mortality-ndi/fig/SPRINT_EHR_SBP_LongTerm_Comparison_122721.png', 
  dpi = 600
)
